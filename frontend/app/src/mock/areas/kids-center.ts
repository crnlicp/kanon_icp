...
export const mockActivities: ActivityReturn[] = [
  ...
  },
  {
    ...
    customFormFields: [
      { id: 1n, fieldType: "text", label_fa: "نام کودک", label_sv: "Barnets namn", placeholder_fa: "نام کامل کودک", placeholder_sv: "Barnets fullständiga namn", required: true, options: [], isLookupField: false, perMember: false, excludeFromCapacityWhenChecked: false, unique: false, allowedValues: [], sortOrder: 1n },
      { id: 2n, fieldType: "number", label_fa: "سن کودک", label_sv: "Barnets ålder", placeholder_fa: "سن (سال)", placeholder_sv: "Ålder (år)", required: true, options: [], isLookupField: false, perMember: false, excludeFromCapacityWhenChecked: false, minValue: 1n, maxValue: 17n, unique: false, allowedValues: [], sortOrder: 2n },
      ...
      { id: 4n, fieldType: "phone", label_fa: "تماس والدین", label_sv: "Förälderns telefon", placeholder_fa: "", placeholder_sv: "", required: true, options: [], isLookupField: false, perMember: false, excludeFromCapacityWhenChecked: false, unique: false, allowedValues: [], sortOrder: 4n },
      { id: 5n, fieldType: "text", label_fa: "آلرژی به مواد", label_sv: "Allergi mot material", placeholder_fa: "مثلاً لاتکس، رنگ‌های خاص", placeholder_sv: "T.ex. latex, specifika färger", required: false, options: [], isLookupField: false, perMember: false, excludeFromCapacityWhenChecked: false, unique: false, allowedValues: [], sortOrder: 5n },
    ],
  ...
  },
  {
    ...
    customFormFields: [
      { id: 1n, fieldType: "text", label_fa: "نام کودک", label_sv: "Barnets namn", placeholder_fa: "", placeholder_sv: "", required: true, options: [], isLookupField: false, perMember: false, excludeFromCapacityWhenChecked: false, unique: false, allowedValues: [], sortOrder: 1n },
      { id: 2n, fieldType: "select", label_fa: "پایه تحصیلی", label_sv: "Skolklass", placeholder_fa: "انتخاب کنید", placeholder_sv: "Välj", required: true, options: [{ fa: "کلاس اول و دوم", sv: "Klass 1–2" }, { fa: "کلاس سوم و چهارم", sv: "Klass 3–4" }, { fa: "کلاس پنجم و ششم", sv: "Klass 5–6" }], isLookupField: false, perMember: false, excludeFromCapacityWhenChecked: false, unique: false, allowedValues: [], sortOrder: 2n },
      { id: 3n, fieldType: "text", label_fa: "نام والدین", label_sv: "Förälderns namn", placeholder_fa: "", placeholder_sv: "", required: true, options: [], isLookupField: false, perMember: false, excludeFromCapacityWhenChecked: false, unique: false, allowedValues: [], sortOrder: 3n },
      { id: 4n, fieldType: "email", label_fa: "ایمیل والدین", label_sv: "Förälderns e-post", placeholder_fa: "", placeholder_sv: "", required: true, options: [], isLookupField: false, perMember: false, excludeFromCapacityWhenChecked: false, unique: false, allowedValues: [], sortOrder: 4n },
      { id: 5n, fieldType: "text", label_fa: "آلرژی شیمیایی", label_sv: "Kemisk allergi", placeholder_fa: "مثلاً لاتکس، برخی رنگ‌ها", placeholder_sv: "T.ex. latex, vissa färger", required: false, options: [], isLookupField: false, perMember: false, excludeFromCapacityWhenChecked: false, unique: false, allowedValues: [], sortOrder: 5n },
      { id: 6n, fieldType: "checkbox", label_fa: "فرزندم قوانین ایمنی آزمایشگاه را رعایت می‌کند", label_sv: "Mitt barn följer laboratoriesäkerhetsreglerna", placeholder_fa: "", placeholder_sv: "", required: true, options: [], isLookupField: false, perMember: false, excludeFromCapacityWhenChecked: false, unique: false, allowedValues: [], sortOrder: 6n },
    ],
  ...
  // Drama
  {
    ...
    highlighted: true,
    customFormFields: [
      { id: 1n, fieldType: "text", label_fa: "نام نوجوان", label_sv: "Ungdomens namn", placeholder_fa: "", placeholder_sv: "", required: true, options: [], isLookupField: false, perMember: false, excludeFromCapacityWhenChecked: false, unique: false, allowedValues: [], sortOrder: 1n },
      { id: 2n, fieldType: "number", label_fa: "سن", label_sv: "Ålder", placeholder_fa: "", placeholder_sv: "", required: true, options: [], isLookupField: false, perMember: false, excludeFromCapacityWhenChecked: false, minValue: 1n, maxValue: 17n, unique: false, allowedValues: [], sortOrder: 2n },
      { id: 3n, fieldType: "radio", label_fa: "تجربه قبلی نمایش", label_sv: "Tidigare teatererfarenhet", placeholder_fa: "", placeholder_sv: "", required: true, options: [{ fa: "هیچ تجربه‌ای ندارم", sv: "Ingen erfarenhet" }, { fa: "کمی تجربه دارم", sv: "Lite erfarenhet" }, { fa: "در گروه نمایشی بوده‌ام", sv: "Har medverkat i teatergrupp" }], isLookupField: false, perMember: false, excludeFromCapacityWhenChecked: false, unique: false, allowedValues: [], sortOrder: 3n },
      { id: 4n, fieldType: "phone", label_fa: "تماس والدین", label_sv: "Förälderns telefon", placeholder_fa: "", placeholder_sv: "", required: true, options: [], isLookupField: false, perMember: false, excludeFromCapacityWhenChecked: false, unique: false, allowedValues: [], sortOrder: 4n },
    ],
  ...
  },
  {
    ...
    customFormFields: [
      { id: 1n, fieldType: "text", label_fa: "نام نوجوان", label_sv: "Ungdomens namn", placeholder_fa: "", placeholder_sv: "", required: true, options: [], isLookupField: false, perMember: false, excludeFromCapacityWhenChecked: false, unique: false, allowedValues: [], sortOrder: 1n },
      { id: 2n, fieldType: "number", label_fa: "سن", label_sv: "Ålder", placeholder_fa: "", placeholder_sv: "", required: true, options: [], isLookupField: false, perMember: false, excludeFromCapacityWhenChecked: false, minValue: 1n, maxValue: 17n, unique: false, allowedValues: [], sortOrder: 2n },
      { id: 3n, fieldType: "radio", label_fa: "تجربه در طبیعت", label_sv: "Utomhuserfarenhet", placeholder_fa: "", placeholder_sv: "", required: true, options: [{ fa: "بدون تجربه قبلی", sv: "Ingen tidigare erfarenhet" }, { fa: "چند سفر کمپینگ", sv: "Några campingresor" }, { fa: "تجربه پیاده‌روی و کمپینگ زیاد", sv: "Stor erfarenhet av vandring och camping" }], isLookupField: false, perMember: false, excludeFromCapacityWhenChecked: false, unique: false, allowedValues: [], sortOrder: 3n },
      { id: 4n, fieldType: "text", label_fa: "نام والدین / سرپرست", label_sv: "Förälderns / vårdnadshavarens namn", placeholder_fa: "", placeholder_sv: "", required: true, options: [], isLookupField: false, perMember: false, excludeFromCapacityWhenChecked: false, unique: false, allowedValues: [], sortOrder: 4n },
      { id: 5n, fieldType: "phone", label_fa: "تماس والدین", label_sv: "Förälderns telefon", placeholder_fa: "", placeholder_sv: "", required: true, options: [], isLookupField: true, perMember: false, excludeFromCapacityWhenChecked: false, unique: false, allowedValues: [], sortOrder: 5n },
      { id: 6n, fieldType: "textarea", label_fa: "شرایط پزشکی یا محدودیت‌های فعالیت", label_sv: "Medicinska tillstånd eller aktivitetsbegränsningar", placeholder_fa: "", placeholder_sv: "", required: false, options: [], isLookupField: false, perMember: false, excludeFromCapacityWhenChecked: false, unique: false, allowedValues: [], sortOrder: 6n },
      { id: 7n, fieldType: "checkbox", label_fa: "خطرات فعالیت‌های خارج از درب را می‌پذیرم و تمام دستورالعمل‌ها را رعایت می‌کنم", label_sv: "Jag accepterar riskerna med utomhusaktiviteter och följer alla instruktioner", placeholder_fa: "", placeholder_sv: "", required: true, options: [], isLookupField: false, perMember: false, excludeFromCapacityWhenChecked: false, unique: false, allowedValues: [], sortOrder: 7n },
    ],
    sessions: [
...
export const mockFormTemplates: FormTemplateReturn[] = [
  {
    ...
    fields: [
      { id: 1n, fieldType: "text", label_fa: "نام کودک", label_sv: "Barnets namn", placeholder_fa: "نام کامل کودک", placeholder_sv: "Barnets fullständiga namn", required: true, options: [], isLookupField: false, perMember: false, excludeFromCapacityWhenChecked: false, unique: false, allowedValues: [], sortOrder: 1n },
      { id: 2n, fieldType: "number", label_fa: "سن کودک", label_sv: "Barnets ålder", placeholder_fa: "سن (سال)", placeholder_sv: "Ålder (år)", required: true, options: [], isLookupField: false, perMember: false, excludeFromCapacityWhenChecked: false, minValue: 1n, maxValue: 17n, unique: false, allowedValues: [], sortOrder: 2n },
      { id: 3n, fieldType: "radio", label_fa: "جنسیت", label_sv: "Kön", placeholder_fa: "", placeholder_sv: "", required: false, options: [{ fa: "پسر", sv: "Pojke" }, { fa: "دختر", sv: "Flicka" }, { fa: "ترجیح نمی‌دهم بگویم", sv: "Föredrar att inte ange" }], isLookupField: false, perMember: false, excludeFromCapacityWhenChecked: false, unique: false, allowedValues: [], sortOrder: 3n },
      { id: 4n, fieldType: "text", label_fa: "نام والدین / سرپرست", label_sv: "Förälderns / vårdnadshavarens namn", placeholder_fa: "", placeholder_sv: "", required: true, options: [], isLookupField: false, perMember: false, excludeFromCapacityWhenChecked: false, unique: false, allowedValues: [], sortOrder: 4n },
      { id: 5n, fieldType: "phone", label_fa: "شماره تماس والدین", label_sv: "Förälderns telefonnummer", placeholder_fa: "", placeholder_sv: "", required: true, options: [], isLookupField: false, perMember: false, excludeFromCapacityWhenChecked: false, unique: false, allowedValues: [], sortOrder: 5n },
      { id: 6n, fieldType: "email", label_fa: "ایمیل والدین", label_sv: "Förälderns e-post", placeholder_fa: "", placeholder_sv: "", required: true, options: [], isLookupField: false, perMember: false, excludeFromCapacityWhenChecked: false, unique: false, allowedValues: [], sortOrder: 6n },
      { id: 7n, fieldType: "phone", label_fa: "شماره اضطراری (غیر از شماره بالا)", label_sv: "Nödtelefon (annan än ovan)", placeholder_fa: "", placeholder_sv: "", required: true, options: [], isLookupField: false, perMember: false, excludeFromCapacityWhenChecked: false, unique: false, allowedValues: [], sortOrder: 7n },
      { id: 8n, fieldType: "textarea", label_fa: "نیازهای پزشکی یا آلرژی", label_sv: "Medicinska behov eller allergier", placeholder_fa: "هر آلرژی، دارو یا نیاز پزشکی که باید بدانیم", placeholder_sv: "Allergier, mediciner eller medicinska behov vi bör känna till", required: false, options: [], isLookupField: false, perMember: false, excludeFromCapacityWhenChecked: false, unique: false, allowedValues: [], sortOrder: 8n },
      { id: 9n, fieldType: "checkbox", label_fa: "رضایت می‌دهم عکس‌های کودکم در رسانه‌های مرکز استفاده شود", label_sv: "Jag godkänner att mitt barns foton används i centrets medier", placeholder_fa: "", placeholder_sv: "", required: false, options: [], isLookupField: false, perMember: false, excludeFromCapacityWhenChecked: false, unique: false, allowedValues: [], sortOrder: 9n },
    ],
  ...
  },
  {
    ...
    fields: [
      { id: 1n, fieldType: "text", label_fa: "نام کودک", label_sv: "Barnets namn", placeholder_fa: "", placeholder_sv: "", required: true, options: [], isLookupField: false, perMember: false, excludeFromCapacityWhenChecked: false, unique: false, allowedValues: [], sortOrder: 1n },
      { id: 2n, fieldType: "number", label_fa: "سن", label_sv: "Ålder", placeholder_fa: "", placeholder_sv: "", required: true, options: [], isLookupField: false, perMember: false, excludeFromCapacityWhenChecked: false, minValue: 1n, maxValue: 17n, unique: false, allowedValues: [], sortOrder: 2n },
      { id: 3n, fieldType: "select", label_fa: "پایه تحصیلی", label_sv: "Skolklass", placeholder_fa: "انتخاب کنید", placeholder_sv: "Välj", required: true, options: [{ fa: "کلاس اول و دوم", sv: "Klass 1–2" }, { fa: "کلاس سوم و چهارم", sv: "Klass 3–4" }, { fa: "کلاس پنجم و ششم", sv: "Klass 5–6" }, { fa: "راهنمایی / کلاس ۷–۹", sv: "Klass 7–9" }], isLookupField: false, perMember: false, excludeFromCapacityWhenChecked: false, unique: false, allowedValues: [], sortOrder: 3n },
      { id: 4n, fieldType: "text", label_fa: "نام والدین", label_sv: "Förälderns namn", placeholder_fa: "", placeholder_sv: "", required: true, options: [], isLookupField: false, perMember: false, excludeFromCapacityWhenChecked: false, unique: false, allowedValues: [], sortOrder: 4n },
      { id: 5n, fieldType: "email", label_fa: "ایمیل والدین", label_sv: "Förälderns e-post", placeholder_fa: "", placeholder_sv: "", required: true, options: [], isLookupField: false, perMember: false, excludeFromCapacityWhenChecked: false, unique: false, allowedValues: [], sortOrder: 5n },
      { id: 6n, fieldType: "checkbox", label_fa: "فرزندم قوانین ایمنی آزمایشگاه / کارگاه را رعایت می‌کند", label_sv: "Mitt barn följer säkerhetsreglerna i laboratoriet/verkstaden", placeholder_fa: "", placeholder_sv: "", required: true, options: [], isLookupField: false, perMember: false, excludeFromCapacityWhenChecked: false, unique: false, allowedValues: [], sortOrder: 6n },
    ],
